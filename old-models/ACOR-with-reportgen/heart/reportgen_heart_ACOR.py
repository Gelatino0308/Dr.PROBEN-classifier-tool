...
def generate_summary_chart(results, reports_dir, timestamp):
    """
    Generates a combined chart for the SOCHA-ACOR Heart Disease model.
    """
    ...
    fig.suptitle('ACOR Heart Disease Model Performance (Averaged over 50 Runs)', fontsize=16, weight='bold')
    ...
    cm_labels = ['Healthy (0)', 'Diseased (1)']
    ...
    output_filename = os.path.join(reports_dir, f'heart_ACOR-socha_perf_summary_{timestamp}.png')
