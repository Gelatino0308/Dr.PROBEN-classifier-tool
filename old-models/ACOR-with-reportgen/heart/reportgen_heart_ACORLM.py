...
def generate_summary_chart(results, reports_dir, timestamp):
    """
    Generates a combined chart for the ACOR-LM Heart Disease model.
    """
    ...
    fig.suptitle('ACOR-LM Heart Disease Model Performance (Averaged over 50 Runs)', fontsize=18, weight='bold')
    ...
    output_filename = os.path.join(reports_dir, f'ACOR-LM_perf_summary_heart_{timestamp}.png')
