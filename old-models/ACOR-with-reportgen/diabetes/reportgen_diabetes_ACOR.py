...
def generate_summary_chart(results, reports_dir, timestamp):
    """
    Generates a combined chart for the SOCHA-ACOR Diabetes model.
    """
    ...
    fig.suptitle('ACOR Diabetes Model Performance (Averaged over 50 Runs)', fontsize=18, weight='bold')
    ...
    output_filename = os.path.join(reports_dir, f'diabetes_ACOR-socha_perf_summary_{timestamp}.png')
