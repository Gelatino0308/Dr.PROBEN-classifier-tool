...
from reportgen_diabetes_ACOR import generate_summary_chart
...
def evaluate_acor(X_train, X_test, y_train, y_test, n_runs=50):
    ...
    for run in range(n_runs):
        ...
        acor = SOCHA_ACOR(
            obj_func=obj_func, dim=num_weights, n_ants=2, n_samples=136,
            q=0.8, xi=0.7, max_iter=100, patience=15, seed=42 + run
        )
...
if __name__ == "__main__":
    print("SOCHA-ACOR for Diabetes Classification")
    print("=" * 60)
    ...
    pkl_filename = f'diabetes_socha_acor_model_{timestamp}.pkl'
