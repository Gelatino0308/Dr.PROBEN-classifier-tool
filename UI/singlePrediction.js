document.addEventListener('DOMContentLoaded', () => {
    ...
    let currentModelType = sessionStorage.getItem('selectedModelType') || 'hybrid'; // Default model type
    ...
    // Initialize model selector (Hybrid vs Baseline)
    ...
    if (modelSelect) {
        ...
        modelSelect.addEventListener('change', () => {
            ...
            sessionStorage.setItem('selectedModelType', currentModelType);
        });
    }

    function getSelectedModelType() {
        return currentModelType || 'hybrid';
    }
    ...
    form.addEventListener('submit', async function(e) {
        ...
        // Attach model type (hybrid / baseline)
        formData.model_type = getSelectedModelType();
