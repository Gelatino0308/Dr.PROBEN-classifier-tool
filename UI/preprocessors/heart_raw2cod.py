"""
Encode heart disease dataset rows to PROBEN1 format.

Transforms 13 raw features to 35 normalized features:
- Continuous features: min-max scaled with missing indicators
- Categorical features: one-hot encoded with missing slots
- Label: Binary [1,0]/[0,1] for healthy/diseased (classifier mode)
"""
