"""
ACOR-LM with Multiple Colonies for Cancer Classification - System Training
...
def train_and_save_model():
    ...
    model_data = {
        'best_model_weights': best_weights,  # Changed key name to match app.py expectation
        'scaler': scaler,
        'architecture': {
            'input': input_dim,
            'hidden': hidden_dim,
    ...
    output_path = os.path.join(os.path.dirname(__file__), 'acor_lm_cancer_model.pkl')
...
if __name__ == "__main__":
    print("=" * 60)
    print("HYBRID ACOR-LM - CANCER CLASSIFICATION SYSTEM TRAINING")
    print("=" * 60)
