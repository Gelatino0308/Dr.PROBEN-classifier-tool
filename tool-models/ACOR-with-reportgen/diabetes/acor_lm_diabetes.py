...
# --- Import the generic function from your new reporting file ---
from reportgen_diabetes_ACORLM import generate_summary_chart
...
def evaluate_acor_lm(X_train, X_test, y_train, y_test, n_runs=50):
    ...
    for run in range(n_runs):
        ...
        acor_lm = MultipleColonyACOR(
            ...
            n_samples=136, q=0.8, xi=0.7, max_iter=100, patience=15,
...
if __name__ == "__main__":
    ...
    pkl_filename = f'diabetes_ACORLM_model_{timestamp}.pkl'
    ...
    model_data = {
        ...
        'algorithm': 'ACOR-LM with Multiple Colonies', 'dataset': 'diabetes1.dat (8 features)',
        'scaler': scaler
    }
    ...
    generate_summary_chart(
        ...
        timestamp=timestamp,
        model_name='ACOR-LM Diabetes Model',
