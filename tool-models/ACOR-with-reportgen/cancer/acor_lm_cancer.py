...
from reportgen_cancer_ACORLM import generate_summary_chart
...
def evaluate_acor_lm(X_train, X_test, y_train, y_test, n_runs=50):
    ...
    for run in range(n_runs):
        ...
        acor_lm = MultipleColonyACOR(
            ...
            n_samples=148, q=0.95, xi=0.98, max_iter=100, patience=15,
...
if __name__ == "__main__":
    ...
    pkl_filename = f'cancer_ACORLM_model_{timestamp}.pkl'
    ...
    model_data = {
        ...
        'algorithm': 'ACOR-LM with Multiple Colonies', 'dataset': 'cancer1.dat (9 features)',
        'scaler': scaler
    }
