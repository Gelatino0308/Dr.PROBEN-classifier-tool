...
def generate_summary_chart(results, reports_dir, timestamp):
    """
    Generates a combined chart for the SOCHA-ACOR Cancer model.
    """
    ...
    fig.suptitle('ACOR Cancer Model Performance (Averaged over 50 Runs)', fontsize=18, weight='bold')
    ...
    output_filename = os.path.join(reports_dir, f'cancer-ACOR-socha_perf_summary_{timestamp}.png')
